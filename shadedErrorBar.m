function varargout=shadedErrorBar(h,x,y,errBar,varargin)
...
H = makePlot(h,x,y,errBar,lineProps,transparent,patchSaturation);
...
function H = makePlot(h,x,y,errBar,lineProps,transparent,patchSaturation)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Plot to get the parameters of the line

    H.mainLine=plot(h,x,y,lineProps{:});
